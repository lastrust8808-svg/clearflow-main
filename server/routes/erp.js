...
import {
  ...
  buildSettlementExecution,
} from '../services/paymentExecution.js';
...
router.get('/settlements/execution-capabilities', (_req, res) => {
  return res.status(200).json({
    success: true,
    capabilities: buildExecutionCapabilities(),
  });
});
