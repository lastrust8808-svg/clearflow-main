...
export const subnavItems = [
  { id: 'dashboard', label: 'Dashboard', description: 'Return to the accounting overview, KPIs, and recent activity.' },
  { id: 'customers', label: 'Customers', description: 'Manage customer records, receivable parties, and contact details.' },
  { id: 'vendors', label: 'Vendors', description: 'Manage payees, vendors, remit rules, and vendor control records.' },
  { id: 'invoices', label: 'Invoices', description: 'Create and review receivables, delivery status, and balances due.' },
  { id: 'bills', label: 'Bills', description: 'Review payables, uploaded bills, and bill-linked accounting intake.' },
  { id: 'presentments', label: 'Presentments', description: 'Work coupon and remittance presentments tied to obligations and proofs.' },
  { id: 'payments', label: 'Remittance Desk', description: 'Control outgoing and incoming payments, releases, and settlement tracking.' },
  { id: 'journal', label: 'Journal', description: 'Post and review journal entries and ledger-side accounting moves.' },
  { id: 'coa', label: 'Chart of Accounts', description: 'Review account structure, remittance classifications, and automation mappings.' },
  { id: 'receipts', label: 'Receipts', description: 'Capture receipt uploads, merchant evidence, and receipt-backed expenses.' },
  { id: 'expenses', label: 'Expenses', description: 'Review expense entries and operating outflows.' },
  { id: 'recurring', label: 'Recurring', description: 'Manage recurring obligations, schedules, and recurring payment posture.' },
  { id: 'payroll', label: 'Payroll', description: 'Manage employees, payroll setup, and direct deposit workflows.' },
  { id: 'bankFeed', label: 'Bank Feed', description: 'Connect accounts, sync statement activity, and post bank-feed transactions.' },
  { id: 'reconciliation', label: 'Reconciliation', description: 'Match statements, clear items, and close reconciliation work.' },
  { id: 'railOps', label: 'Rails & Codes', description: 'Track movement IDs, return events, reclamations, and reporting links.' },
  { id: 'quotes', label: 'Quotes', description: 'Prepare estimates and quote-style proposals before issuing invoices.' },
  { id: 'intercompany', label: 'Intercompany', description: 'Record due-to / due-from transfers between connected entities.' },
] as const;
